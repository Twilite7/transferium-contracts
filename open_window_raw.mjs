...
const closesAt = opensAt  + 86400n * 30n; // 30 days — under 90 day STANDARD cap
...
// I use windowType = 0 (STANDARD) — not 1 (EXCEPTIONAL which is capped at 10 days)
console.log("windowType: 0 = STANDARD");
...
if (receipt.status === 1) {
  console.log("Waiting 130s for opensAt to pass...");
  await new Promise(r => setTimeout(r, 130_000));

  console.log("Advancing to active...");
